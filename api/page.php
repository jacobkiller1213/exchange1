...
if ($pageCode === "about") {
    $arr = [
        ...
        "data"   => [
            ...
            "seoTitle"       => "Об обменнике AsteriChain",
            "seoDescription" => "",
            "seoH1"          => "О нас"
        ]
    ];
...
В случае, если Вы не согласны с условиями Пользовательского соглашения, использование сайта AsteriChain не допускается.
...
2.1. AsteriChain — это торговая марка системы, предоставляющей Пользователям возможность обмена цифровой и электронной валюты.

2.2. Сервис — система предоставления интернет-услуг по обмену, продаже и покупке цифровых и/или электронных валют.

2.3. Пользователь — это любое физическое/юридическое лицо, использующее услуги сервиса AsteriChain.
...
<h1>Правила пользования сайтом AsteriChain</h1>
3.1. Пользователь обязуется использовать сайт AsteriChain исключительно в законных целях и в соответствии с настоящим Соглашением.

3.2. Сайт AsteriChain предназначен для использования исключительно в личных целях. Пользуясь услугами данного сервиса, Вы даете свое согласие на передачу AsteriChain достоверных данных о себе. Вы так же даете согласие на обработку личных данных.
...
<h1>Услуги, предоставляемые сайтом AsteriChain</h1>
...
4.9. Все услуги сервиса AsteriChain предоставляются без каких-либо явных или подразумеваемых гарантий, в частности, без подразумеваемых гарантий товарной пригодности и пригодности для определенной цели. Компания не гарантирует, что услуги AsteriChain, а также сайт AsteriChain будут доступны в 100% случаев для удовлетворения Ваших потребностей. Компания будет стремиться предоставить вам свои услуги как можно скорее, но нет никаких гарантий, что доступ не будет прерван или что не будет никаких задержек, сбоев, ошибок, упущений или потери передаваемой информации.

4.10. AsteriChain будет прилагать разумные усилия для обеспечения доступа к услугам и сайту AsteriChain в соответствии с настоящим Соглашением. Тем не менее, AsteriChain может приостановить использование сайта для технического обслуживания и приложит разумные усилия, чтобы предварительно уведомить Вас об этом. Таким образом, Вы соглашаетесь с тем, что принимаете на себя риски, связанные с тем фактом, что вы не всегда можете пользоваться услугами и сайтом AsteriChain или выполнять срочные транзакции.

<h1>Дополнительные правила пользования сайтом AsteriChain</h1>
...
7.1. Сервис AsteriChain предоставляет услуги по обмену, покупке и продаже электронных активов. Сервис AsteriChain не предоставляет услуги по сбору средств, не предоставляет услуг по оплате товаров.

7.2. Сервис AsteriChain не несет ответственности перед Пользователем за финансовые потери, вызванные незаконными действиями третьих сторон, которые невозможно предсказать или предотвратить.

7.3. Сервис AsteriChain не несет ответственности за любые отложенные или нереализованные Заявки, вызванные ошибкой другой Платежной системы или банка, указанными пользователем в оформленной Заявке. Пользователь соглашается с тем, что в таком случае все претензии будут направлены в платежную систему или банк. Сервис AsteriChain окажет необходимую помощь для подачи жалобы или требования другому партнеру или банку.

7.4. Сумма в заявке пользователя и сумма отправленная пользователем по данной заявке должны полностью совпадать. В случае неучета комиссии, или же в другом случае несовпадения суммы, пользователь обязуется совершить повторный платеж правильной суммы с учетом данной комиссии. После успешного проведения повторной транзакции сервис обязуется совершить возврат обеих транзакций совершенных пользователем. В случае несоблюдения данного правила, средства пользователя будут заморожены. По истечению 48 часов средства обозначаться как утерянная криптовалюта и будут списаны со счета сервиса AsteriChain соответствующими органами регуляторов в лице Комитета Государственной Думы по финансовому рынку.
...
7.6. Сервис AsteriChain не несёт ответственности за частичное или полное несоблюдение данных Условий использования, если таковое явилось следствием обстоятельств непреодолимой силы, которые невозможно предотвратить разумными мерами.
...
7.10. Пользователь несет ответственность за достоверность и полноту информации и данных, которые он предоставил во время создания заявки. В случае, если Пользователь ввел неправильные личные данные или предоставил неверные данные для исполнения Заявки, Сервис AsteriChain не несёт ответственности за любые убытки Пользователя, возникшие в результате такой ошибки.
...
9.1. Использование Сервиса AsteriChain в целях осуществления мошеннических и незаконных операций запрещено.

9.2. Операторы сервиса AsteriChain юридически обязаны предоставлять информацию о платежах, Пользователях и Операциях любым государственным органам, имеющим законное право запрашивать соответствующую информацию.
...
9.4. Способ обработки и защиты личной информации подробно описан в Политике конфиденциальности, опубликованной на веб-сайте Сервиса AsteriChain, требуемой для заключения договорных отношений между Пользователем и Сервисом AsteriChain.

9.5. Сервис AsteriChain, в случае подозрительных действий в процессе оформления заявки Пользователем, во избежание ущерба от хакерских атак, вправе приостанавливать выполнение таких операций до выяснения причин этих действий.

9.6. Сервис AsteriChain вправе отказать в выполнении операции обмена, покупки и продажи электронных/цифровых валют, если передача электронного актива на счет Сервиса была произведена без оформления Заявки при помощи пользовательских интерфейсов на Сайте Сервиса.
...
9.9. Срок ответа службы поддержки Сервиса AsteriChain может составлять до 24 часов с момента получения соответствующего запроса Пользователя.
...
11.2. Сервис AsteriChain вправе в одностороннем порядке вносить изменения в Соглашение путем публикации изменений на Сайте Сервиса. Изменения вступают в силу с момента опубликования, если иной срок вступления изменений в силу не определен дополнительно при их публикации. Пользователь имеет право расторгнуть договорные отношения с Сервисом AsteriChain из-за его несогласия с изменением таких Условий. Пользователь должен уведомить Сервис AsteriChain о своем несогласии с изменением Условий и прекращению договорных отношений.

11.3. Сервис AsteriChain вправе отправлять Пользователю на указанный им e-mail информацию рекламного характера.

11.4. Информация, размещенная на сайте, включая все графические изображения, текстовую информацию, коды программ и т.д., является собственностью AsteriChain и защищена законами об авторском праве.

11.5. Пользователь подтверждает, что он ознакомлен со всеми положениями настоящих Условий и полностью принимает их.

<h1>Контактные данные</h1>
12.1. Вы можете обратиться в службу поддержки в рабочее время посредством доступного мессенджера, указанного на сайте AsteriChain.</div>
